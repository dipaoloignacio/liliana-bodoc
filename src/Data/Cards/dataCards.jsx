...
import foto1 from '../../images/img-body/21-de-julio/actividad-21julio.jpg'
import foto2 from '../../images/img-body/contar-para-que-ocurra/contar.jpg'
import foto3 from '../../images/img-body/donaciones-libros.jpg'
let cards = [
    {
    ...
    },
    {
        ...
        description: 'La Fundación Liliana Bodoc tiene como uno de sus propósitos realizar donaciones periódicas de libros de literatura infantil y juvenil a bibliotecas populares de la Provincia, y de otros sitios del país que lo requieran.',
        link: '/que-hacemos/donaciones',
        img:  foto3
    },
]
