...
import FotoCard1 from '../../images/img-body/21-de-julio/21-julio.jpg'
                ...
                <div className='content-cards'>
                    <div className="card" >
                        ...
                        <div className="card-body">
                            <h5 lassNamess="card-title">21 de julio</h5>
                    ...
                    <div className="card" >
                        ...
                        <div className="card-body">
                            <h5 lassNamess="card-title">Mujeres de los confines</h5>
